              ...
              >
                <div
                  className={`text-white flex-col justify-center items-center font-bold cursor-pointer ${
                    activeTab == "day" ? "bg-gray-700 px-3" : ""
                  }`}
                  onClick={() => {
                    setActiveTab("day");
                  }}
                >
                  ...
                  <p
                    className={`${
                      i.change_volume >= 0 ? "text-green-400" : "text-red-500"
                    }`}
                  >
                ...
                <div
                  className={`text-white flex-col justify-center items-center font-bold cursor-pointer ${
                    activeTab == "week" ? "bg-gray-700 px-3" : ""
                  }`}
                  onClick={() => {
                    setActiveTab("week");
                  }}
                >
                  ...
                  <p
                    className={` ${
                      i.change_week >= 0 ? "text-green-400" : "text-red-500"
                    }`}
                  >
                ...
                <div
                  className={`text-white flex-col justify-center items-center font-bold cursor-pointer ${
                    activeTab == "month" ? "bg-gray-700 px-3" : ""
                  }`}
                  onClick={() => {
                    setActiveTab("month");
                  }}
                >
                  ...
                  <p
                    className={` ${
                      i.change_month >= 0 ? "text-green-400" : "text-red-500"
                    }`}
                  >
                ...
                <div
                  className={`text-white flex-col justify-center items-center font-bold cursor-pointer ${
                    activeTab == "year" ? "bg-gray-700 px-3" : ""
                  }`}
                  onClick={() => {
                    setActiveTab("year");
                  }}
                >
                  ...
                  <p
                    className={` ${
                      i.change_year >= 0 ? "text-green-400" : "text-red-500"
                    }`}
                  >
